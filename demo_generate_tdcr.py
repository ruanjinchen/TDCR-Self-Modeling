...
python demo_generate_tdcr.py \
  --ckpt /data/fllm/code/TDCR-Self-Modeling/runs_final/sim_5m_with_base_hybrid_bighead_tau0.97/ckpts/latest.pt \
  --data_dir datasets/sim/5m_with_base \
  --split test \
  --demo_out demo_out/sim_5m_with_base_hybrid_bighead_tau0.97 \
  --sampler heun \
  --sample_steps 50 \
  --prior_std 0.5 \
  --rgb_key rgb \
